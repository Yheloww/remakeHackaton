<section id="solutions">
    <div id="header-solution" class="center">
        <h1>Alors que faire pour pallier ce manque et répondre à la demande des étudiants ?</h1>
        <p>Afin de répondre à cette demande et d’améliorer l’offre de cours traitant des enjeux climatiques dans l’enseignement supérieur belge, l’asbl émet différentes propositions 
            </p>
    </div>
